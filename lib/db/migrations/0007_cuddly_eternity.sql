...
INSERT INTO `__new_tracks`("id", "uuid", "path", "library_root_id", "fingerprint", "file_mtime", "file_size_bytes", "title", "artist_id", "album_id", "track_number", "track_total", "disc_number", "disc_total", "year", "genre", "duration_seconds", "format", "codec", "bitrate", "sample_rate", "bit_depth", "channels", "lossless", "cover_art_path", "waveform_path", "waveform_status", "waveform_peak_count", "waveform_avg_level", "play_count", "last_played_at", "raw_tags_json", "bpm", "bpm_source", "key", "key_source", "analysis_status", "analysis_error", "analyzed_at", "import_job_id", "date_added", "date_modified", "missing_since", "deleted_at") SELECT "id", "uuid", "path", "library_root_id", "fingerprint", "file_mtime", "file_size_bytes", "title", "artist_id", "album_id", "track_number", "track_total", "disc_number", "disc_total", "year", "genre", "duration_seconds", "format", "codec", "bitrate", "sample_rate", "bit_depth", "channels", "lossless", "cover_art_path", "waveform_path", "waveform_status", "waveform_peak_count", "waveform_avg_level", "play_count", "last_played_at", "raw_tags_json", NULL, NULL, NULL, NULL, 'none', NULL, NULL, "import_job_id", "date_added", "date_modified", "missing_since", "deleted_at" FROM `tracks`;--> statement-breakpoint
